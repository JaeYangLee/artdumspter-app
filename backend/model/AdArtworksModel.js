...
const addArtwork = async (
  ...
  const res = await pool.query(
    "INSERT INTO artworks(user_id, title, description, image_url, tool_id, artstyle_id) VALUES($1, $2, $3, $4, $5, $6) RETURNING artwork_id, user_id, title, description, image_url, tool_id, artstyle_id, created_at",
...
const updateArtwork = async (
  ...
  const res = await pool.query(
    "UPDATE artworks SET title = $1, description = $2, tool_id = $3, artstyle_id = $4 WHERE artwork_id = $5 AND user_id = $6 RETURNING artwork_id",
