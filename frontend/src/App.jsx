  ...
  const registerUser = async (
    ...
    try {
      const registeredUser = await axios.post(
        `${import.meta.env.VITE_API_URL}/artDumpster/register`,
        {
          username,
          email,
          password,
  ...
  const loginUser = async (email, password) => {
    try {
      const loggedInUser = await axios.post(
        `${import.meta.env.VITE_API_URL}/artDumpster/login`,
        {
          email,
          password,
        },
  ...
  const getUserById = async () => {
    ...
    try {
      const fetchedUserId = await axios.get(
        `${import.meta.env.VITE_API_URL}/artDumpster/profile`,
        {
          headers: {
  ...
  const updateUser = async (
    ...
    try {
      const updatedUser = await axios.put(
        `${import.meta.env.VITE_API_URL}/artDumpster/profile/${user_id}`,
        {
          username,
          email,
          password,
  ...
  const fetchArtworkById = async (artwork_id) => {
    try {
      ...
      const artworkById = await axios.get(
        `${import.meta.env.VITE_API_URL}/artDumpster/artWork/${artwork_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const updateArtwork = async (
    ...
    try {
      ...
      const updatedArtwork = await axios.put(
        `${import.meta.env.VITE_API_URL}/artDumpster/artWork/edit/${artwork_id}`,
