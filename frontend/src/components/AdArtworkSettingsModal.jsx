        ...
        >
          <ul className="flex flex-col items-center justify-center">
            <li
              ...
              className="w-full px-4 py-2 text-center text-red-500 border-b border-textColor cursor-pointer hover:shadow-[inset_0_-8px_8px_rgba(0,0,0,0.1)] transition duration-200 active:bg-gray-300"
            >
              Delete
            </li>
            <li
